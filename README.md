...
- **响应式设计** — 电脑、平板、手机都能用
- !!!**推荐组合** 本project + 任何一个可以修改浏览器位置定位的拓展程序(此处强烈推荐使用[MyLocationGuard]https://mylocationguard.org/)
    

## 在线使用

👉 **[https://auto-checkin-six.vercel.app/](https://auto-checkin-six.vercel.app/)**
